...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    step, total, diceroll,ones = 0, 0, 0, 0
...
def free_bacon(opponent_score):
    ...
    if opponent_score < 10:
        ...
        rest, first = opponent_score//10, opponent_score%10
        return max(rest, first) + 1
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if is_prime(total):
        after_hogtimus = next_prime(total)
    else:
        after_hogtimus = total
    if after_hogtimus > 25 - num_rolls:
        after_pigsfly = 25 - num_rolls
    else:
        after_pigsfly = after_hogtimus
    return after_pigsfly
    ...
    def rerolled():
        ...
        while i < 1 :
            if rolled_value %2 != 0:
                rolled_value = dice()
                i+=1
            return rolled_value  # Replace this statement
    return rerolled
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    """def strategy0(score0, score1):
        return select_dice(score0, score1, dice_swapped) 

    def strategy1(score1, score0):
        return select_dice(score1, score0, dice_swapped)"""
    ...
    """while score0 < goal and score1 < goal:
        ...
        if player == 0:
            if move0 == -1:
                ...
                score0 +=take_turn(move0, score1, select_dice(score0, score1, dice_swapped))
        else:
            if move1 == -1:
                score1 += 1
                dice_swapped = not dice_swapped
            else:
                score1 += take_turn(move1, score0, select_dice(score1, score0, dice_swapped))
...
def final_strategy(score, opponent_score):
    ...
    If score > opponent_score, we do not want to risk using swap_strategy, which may swap our higher score with the opponent's lower score.
    Otherwise, score < opponent score is beneficial for swap_strategy
    """
    # BEGIN PROBLEM 11
